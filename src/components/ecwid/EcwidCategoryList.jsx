...
const EcwidCategoryList = ({ categories, selectedCategory, onSelectCategory, categorySlug }) => {
    ...
    return (
        <div className="space-y-8 mb-12">
            ...
            <div className="relative group max-w-full mx-auto">
                ...
                >
                    <motion.button
                        ...
                        className={`flex-none flex items-center gap-3 px-6 py-3 rounded-md text-sm font-bold transition-all duration-300 border ${isAllSelected
                    ...
                    >
                        {contextParent ? (
                            <>
                                ...
                                <span>Tout {contextParent.name}</span>
                            </>
                        ) : (
                    ...
                    {displayCategories.map((category) => {
                        ...
                        return (
                            <motion.button
                                ...
                                className={`flex-none flex items-center gap-3 px-6 py-3 rounded-md text-sm font-bold transition-all duration-300 border ${isSelected
                                    ? "bg-pmc-blue border-pmc-blue text-white shadow-lg shadow-pmc-blue/30"
                                    : "bg-white border-pmc-blue/10 text-pmc-blue hover:border-pmc-blue hover:shadow-sm"
                                    }`}
                            >
            ...
            <AnimatePresence mode="wait">
                {!contextParent && subCategories.length > 0 && (
                    <motion.div

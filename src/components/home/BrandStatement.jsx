  ...
  return (
    <section className="w-full py-16 md:py-24 bg-white overflow-hidden">
      <div className="max-w-5xl mx-auto px-6 text-center relative">
        ...
        >
          {/* Accent Label */}
          <span className="inline-block text-[10px] md:text-xs font-bold tracking-[0.3em] uppercase text-pmc-yellow mb-2">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-neutral-900 tracking-tight leading-none italic font-heading">
            Plaques <span className="text-transparent bg-clip-text bg-gradient-to-r from-pmc-blue via-pmc-yellow to-pmc-blue">Moins Chères</span>
          </h2>
